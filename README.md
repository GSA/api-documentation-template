...
#### HTML Standalone (Jekyll-less)
* A static version of the site which does not rely on Jekyll is available in the example folder. To use, simply open index.html in your browser.
